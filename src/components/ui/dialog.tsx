...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:items-center sm:space-x-2",
      className
    )}
    {...props}
  />
